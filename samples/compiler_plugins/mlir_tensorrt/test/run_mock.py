...
# Usage:
#   iree-compile --iree-plugin=mlir_tensorrt print.mlir -o print.vmfb
...
def create_mlir_tensorrt_module():
  ...
  class MLIRTensorRT:
    ...
    def print_impl(self):
      print("+++ HELLO FROM MLIR_TENSORRT")

  iface = rt.PyModuleInterface("mlir_tensorrt", MLIRTensorRT)
  iface.export("print", "0v_v", MLIRTensorRT.print_impl)
  return iface.create()
